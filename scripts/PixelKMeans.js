...
function addIndices(image) {
  ...
  // 4. Tasseled Cap Wetness (Crucial for Peatlands)
  ...
  // Return the original scaled bands PLUS new indices
  return scaled
...
/*
// Mask out Water
var waterMask = median.normalizedDifference(['B3','B11']).lt(0); // NDWI
composite = composite.updateMask(waterMask.not());
*/ // Makes the polygon too complex
